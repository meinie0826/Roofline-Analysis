...
def kernel(
    ...
    if warp_idx == tma_warp_id:
        ...
        tRS_rC = cute.make_rmem_tensor(tRS_rAcc.shape, output_dtype)
        ...
        for subtile_idx in cutlass.range(subtile_cnt):
            ...
            tRS_rC.store(tRS_rAcc.load().to(output_dtype))
...
def host_function(a: cute.Tensor, b: cute.Tensor, c: cute.Tensor):
    ...
    tma_atom_c, c_tma_tensor = cpasync.make_tiled_tma_atom(
...
if __name__ == "__main__":
    ...
    print("PASS", {"mnk": args.mnk, "variant": "2cta_tma_pipeline_tma_store_ws5epi"})
