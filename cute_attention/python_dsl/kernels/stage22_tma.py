...
def autotune_stage22_config(
    ...
    *,
    ...
    block_m_values = _stage22_candidate_values(config.block_m, [128, 96, 64], limit=seq_len)
    block_n_values = _stage22_candidate_values(config.block_n, [192, 128, 64], limit=seq_len)
