...
class Stage19FlashAttentionWarpgroupExperimental:
    """Independent SM90-oriented warpgroup-layout experimental backend for stage19.
    ...
    def __call__(
        ...
        sQ_layout_atom = warpgroup.make_smem_layout_atom(
            sm90_utils_basic.get_smem_layout_atom(
                LayoutEnum.ROW_MAJOR, self._dtype, self._head_dim_padded
            ),
            self._dtype,
        )
