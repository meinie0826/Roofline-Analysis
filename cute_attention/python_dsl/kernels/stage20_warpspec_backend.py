...
class Stage20FlashAttentionWarpSpecExtreme:
    """Independent SM90-oriented aggressive warpspec backend for stage20.
    ...
    def _steady_state_slot_for_iteration(self, n_tile):
        return (n_tile) % self._steady_state_step()
    ...
    def kernel(
        ...
        for prefetch_slot in cutlass.range_constexpr(self._num_stages_kv):
