...
from flashmla_kernel import FlashMLAKernel, MLADecodeShape


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark FlashMLA decode kernel.")
...
def main() -> int:
    ...
    result = {
        ...
        "selected_backend": "flash_mla_with_kvcache",
        "fallback": False,
        "fallback_reason": None,
        "notes": "MLA-only decode benchmark via FlashMLA.",
    }
