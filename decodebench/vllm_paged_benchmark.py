...
from vllm_paged_kernel import DecodeShape, VLLMPagedDecodeKernel
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark vLLM direct paged_attention kernel.")
...
def main() -> int:
    ...
    kernel = VLLMPagedDecodeKernel(shape)
    torch = kernel.torch
    ...
    result = {
        ...
        "selected_backend": "vllm_paged_attention_v2",
        "fallback": False,
        "fallback_reason": None,
        "notes": "Kernel-only vLLM paged_attention_v2 benchmark. No model/config download, no framework benchmark wrapper.",
    }
