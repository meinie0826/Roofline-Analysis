...
from torch_sdpa_kernel import DecodeShape, TorchSDPADecodeKernel
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark PyTorch SDPA decode baseline.")
...
def main() -> int:
    ...
    kernel = TorchSDPADecodeKernel(shape)
    torch = kernel.torch
    ...
    result = {
        ...
        "selected_backend": "torch_sdpa_decode",
        "fallback": False,
        "fallback_reason": None,
        "notes": "Non-paged PyTorch SDPA decode baseline. Used for rough comparison only; layout differs from paged KV kernels.",
    }
